...
er0 = zeros(k0);  % errors of PNT
er1 = zeros(k1);  % errors of Lagrange
...
legend('PNT', 'Newton', 'genHyb', 'Tikh-DP','Tikh-opt', 'Location', 'northeast','fontsize',15);
...
xlabel('Iteration','Fontsize',16);
legend('PNT', 'Newton','genHyb', 'Tikh-DP', 'Tikh-opt','Fontsize',14, 'Location', 'southeast');
