function [X,rho,eta,F] = lsqr_c(A,b,k,reorth,s)
...
% na = norm(A);
na = 50;
er_m = rands(m,1);  er_n = rands(n,1); 
er_m = er_m/norm(er_m) * 1e-5 * na;
er_n = er_n/norm(er_n) * 1e-5 * na;
